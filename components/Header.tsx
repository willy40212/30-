    ...
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-stone-200">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="serif text-2xl font-semibold tracking-wider text-stone-800">30さんまる</span>
        </div>
        <div className="hidden md:flex gap-8 text-sm font-medium text-stone-600">
          ...
          <a href="#resources" className="hover:text-stone-900 transition-colors">照顧工具包</a>
        ...
        <a 
          ...
          target="_blank"
          className="bg-stone-800 text-white px-4 py-2 rounded-sm text-sm hover:bg-stone-700 transition-all"
        >
          立即報名
        </a>
      </div>
