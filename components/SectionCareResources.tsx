    ...
    <section id="resources" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="serif text-3xl text-stone-900 mb-4">照顧工具包</h2>
          <p className="text-stone-500">透過這些工具，建立屬於自己的照顧藍圖與節奏。</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {resources.map((res, i) => (
            <div key={i} className="p-10 border border-stone-100 rounded-lg hover:shadow-lg hover:border-[#c29967]/30 transition-all text-center flex flex-col items-center">
              ...
              >
                領取 PDF 檔案包 <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
              </a>
            </div>
          ))}
        </div>
